      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/contacts"
              class="<?= urlIS('/contacts') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Contacts</a>
          </div>
        </div>
      </div>
      <div class="hidden md:block">
          ...
          <div class="relative ml-3">
            <div>
              <button type="button"
                ...
                <?php if ($_SESSION['full_name'] ?? false): ?>
